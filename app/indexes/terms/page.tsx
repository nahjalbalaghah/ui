...
export default function IndexTermsPage() {
  ...
  const [filters, setFilters] = useState<IndexTermsFilters>({
    section: '',
    word_english: '',
    word_arabic: '',
  });
  
  const [appliedFilters, setAppliedFilters] = useState<IndexTermsFilters>({
    section: '',
    word_english: '',
    word_arabic: '',
  });
  ...
  const hasActiveFilters = appliedFilters.section || appliedFilters.word_english || appliedFilters.word_arabic;
                  ...
                  <table className="w-full table-fixed">
                    ...
                    <thead className="bg-gray-50 border-b border-gray-200">
                      <tr>
                        ...
                        <th className="px-6 py-4 text-right text-sm font-semibold text-gray-700 whitespace-nowrap">Arabic Word</th>
