...
export const getRelatedContentForManuscript = (manuscriptId: string): RelatedContentItem[] => {
  const reverseMap: Record<string, RelatedContentItem[]> = {
    '1': [
      {
        id: 1,
        type: 'orations',
  ...
  return reverseMap[manuscriptId] || [];
};
