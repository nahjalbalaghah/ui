...
export default function ListViewItem({ item, contentType, displayMode = 'both' }: ListViewItemProps) {
  ...
  return (
    <Link
      href={getCardLink()}
      id={getDisplayNumber() ? `listing-${getDisplayNumber()}` : undefined}
      className="block bg-white rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg hover:border-[#43896B]/30 hover:bg-gray-50/50 transition-all duration-300 overflow-hidden group cursor-pointer"
    >
        ...
        <div className="flex-grow min-w-0 py-6 pr-6 pl-8">
          <div className="flex flex-col lg:flex-row items-end gap-4 lg:items-start justify-between">
            ...
            <div className="flex-shrink-0 flex items-center gap-2">
              <div className="size-10 rounded-full bg-gray-100 group-hover:bg-[#43896B] transition-all duration-300 flex items-center justify-center">
